...
const styles = StyleSheet.create({
  ...
  avatarLgText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 18, color: "#fff" },
  profileInfo: { flex: 1, gap: 5 },
  profileEmail: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 14, color: T.text },
  roleBadge: {
  ...
  roleText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 10, letterSpacing: 0.4 },
  ...
  menuLabel: { flex: 1, fontFamily: "PlusJakartaSans_500Medium", fontSize: 15, color: T.text },
  ...
  confirmBtnCancelText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 14, color: T.text },
  confirmBtnDangerText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 14, color: "#fff" },
  ...
  cancelText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 15, color: T.textSec },
});
