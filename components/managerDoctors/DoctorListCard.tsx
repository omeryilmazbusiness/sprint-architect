...
const styles = StyleSheet.create({
  ...
  avatarText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 16, letterSpacing: 0.5 },
  nameCol: { flex: 1, gap: 2 },
  name: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 15, color: T.text, letterSpacing: -0.2 },
  specialty: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 13, color: T.textSec },
  specialtyMuted: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 13, color: T.textMuted, fontStyle: "italic" },
  ...
  tagText: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 11, color: T.textMuted, flexShrink: 1 },
  tagTextAccent: { color: T.accent, fontFamily: "PlusJakartaSans_500Medium" },
  tagTextSuccess: { color: T.success, fontFamily: "PlusJakartaSans_500Medium" },
  bio: {
