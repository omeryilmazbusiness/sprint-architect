...
const s = StyleSheet.create({
  ...
  statusChipTxt: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 10 },
  grow: { flex: 1, gap: 6 },
  emptyBody: { flex: 1, alignItems: "center", justifyContent: "center", gap: 8 },
  emptyTitleDark:  { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 13, color: "rgba(255,255,255,0.4)" },
  emptySubDark:    { fontFamily: "PlusJakartaSans_400Regular",  fontSize: 11, color: "rgba(255,255,255,0.25)", textAlign: "center" },
  emptyTitleLight: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 13, color: T.textMuted },
  emptySubLight:   { fontFamily: "PlusJakartaSans_400Regular",  fontSize: 11, color: T.textMuted, textAlign: "center" },
  vehicleName: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 18, color: "#fff", letterSpacing: -0.3 },
  plateBadge: {
  ...
  plateText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 12, color: "rgba(255,255,255,0.8)", letterSpacing: 1.5 },
  driverRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  driverAvatar: {
    width: 28, height: 28, borderRadius: 14,
    backgroundColor: "rgba(255,255,255,0.1)", alignItems: "center", justifyContent: "center",
  },
  driverLabel: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 10, color: "rgba(255,255,255,0.4)" },
  driverName:  { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 13, color: "#fff" },
  ctaDark: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 6, backgroundColor: "#fff", borderRadius: T.r10, paddingVertical: 10,
  },
  ctaDarkText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 13, color: "#0D1117" },
  hotelName:   { fontFamily: "PlusJakartaSans_700Bold", fontSize: 16, color: T.text, letterSpacing: -0.3 },
  infoRow:     { flexDirection: "row", alignItems: "center", gap: 5 },
  infoText:    { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textSec, flex: 1 },
  stayRow: {
    flexDirection: "row",
  ...
  stayLbl: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 10, color: T.textMuted },
  stayVal: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 12, color: T.text },
  ...
  ctaLightText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 13, color: T.accent },
  countsRow: { flexDirection: "row", gap: 6 },
  countBox:  { flex: 1, alignItems: "center", paddingVertical: 6, borderRadius: T.r8 },
  countNum:  { fontFamily: "PlusJakartaSans_700Bold", fontSize: 16 },
  countLbl:  { fontFamily: "PlusJakartaSans_400Regular", fontSize: 10, marginTop: 1 },
  docRow: {
    flexDirection: "row", alignItems: "center", gap: 8,
    paddingVertical: 4, borderTopWidth: 1, borderTopColor: T.border,
  },
  docName: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 12, color: T.text, flex: 1 },
  pill:    { borderRadius: 20, paddingHorizontal: 7, paddingVertical: 2 },
  pillTxt: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 9 },
});
