...
const na = StyleSheet.create({
  ...
  body: { flex: 1, gap: 3 },
  title: { fontFamily: "Inter_700Bold", fontSize: 13, lineHeight: 18 },
  sub: { fontFamily: "Inter_400Regular", fontSize: 12, color: "#555", lineHeight: 16 },
  btn: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: T.r10, flexShrink: 0 },
  btnTxt: { fontFamily: "Inter_600SemiBold", fontSize: 11, color: "#fff" },
});
...
const js = StyleSheet.create({
  ...
  label:        { fontFamily: "Inter_600SemiBold", fontSize: 14, color: T.text, lineHeight: 20 },
  ...
  sub: { fontFamily: "Inter_400Regular", fontSize: 12, color: T.textSec, marginTop: 2, lineHeight: 17 },
  ...
  supportTitle: { fontFamily: "Inter_600SemiBold", fontSize: 14, color: T.text, marginBottom: 2 },
  supportRow:   { flexDirection: "row", alignItems: "center", gap: 6 },
  supportLink:  { fontFamily: "Inter_500Medium", fontSize: 13, color: T.accent, textDecorationLine: "underline" },
});
...
const ds = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontFamily: "Inter_400Regular", fontSize: 14, color: T.text },
  ...
  instruction: { fontFamily: "Inter_400Regular", fontSize: 12, color: T.textSec, lineHeight: 17 },
  showMore: { fontFamily: "Inter_600SemiBold", fontSize: 11, color: T.accent, marginTop: 3 },
  rejBox: {
    flexDirection: "row", alignItems: "flex-start", gap: 6,
    padding: T.sp10, backgroundColor: T.dangerBg,
    borderRadius: T.r8, borderLeftWidth: 3, borderLeftColor: T.danger,
  },
  rejText: { fontFamily: "Inter_400Regular", fontSize: 12, color: T.dangerText, flex: 1, lineHeight: 16 },
  ...
  emptyTitle: { fontFamily: "Inter_700Bold",   fontSize: 17, color: T.text },
  emptySub:   { fontFamily: "Inter_400Regular", fontSize: 14, color: T.textMuted, textAlign: "center", lineHeight: 20, maxWidth: 260 },
});
