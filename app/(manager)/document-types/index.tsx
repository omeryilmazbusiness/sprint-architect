...
const styles = StyleSheet.create({
  ...
  errorText: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 14, color: T.textMuted, textAlign: "center" },
  retryBtn: { paddingHorizontal: 20, paddingVertical: 8, borderRadius: 8, backgroundColor: T.accent },
  retryText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 14, color: "#fff" },
  ...
  searchInput: { flex: 1, fontFamily: "PlusJakartaSans_400Regular", fontSize: 14, color: T.text, padding: 0 },
  ...
  cardName: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 16, color: T.text, letterSpacing: -0.2 },
  cardNote: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 13, color: T.textSec, lineHeight: 18, marginTop: 2 },
  cardNotePlaceholder: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 13, color: T.textMuted, fontStyle: "italic", marginTop: 2 },
  cardDate: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textMuted, marginTop: 6 },
  ...
  emptyTitle: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 18, color: T.text, textAlign: "center" },
  ...
  optional: { fontFamily: "PlusJakartaSans_400Regular", color: T.textMuted },
  input: { backgroundColor: "#F9FAFB", borderWidth: 1, borderColor: "#E5E7EB", borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontFamily: "PlusJakartaSans_400Regular", fontSize: 15, color: T.text },
  ...
  btnPrimaryText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 15, color: "#fff" },
  ...
  toastText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 13, color: "#fff", flex: 1 },
});
