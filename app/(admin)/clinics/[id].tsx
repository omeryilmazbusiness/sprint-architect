...
const styles = StyleSheet.create({
  ...
  clinicBadgeText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 16, color: "#fff" },
  clinicName: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 17, color: T.text },
  clinicSince: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textSec },
  ...
  suspendedText: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 12, color: T.danger, flex: 1 },
  ...
  serviceChipText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 12, color: T.accent },
  ...
  contactText: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 14, color: T.text, flex: 1 },
  contactMeta: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 11, color: T.textMuted, marginBottom: 2 },
  notesText: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 14, color: T.textSec, lineHeight: 20 },
  ...
  billingValue: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 13, color: T.text, textAlign: "center" },
  billingLabel: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 11, color: T.textMuted, textAlign: "center" },
  invBanner: { flexDirection: "row", alignItems: "center", gap: 8, borderWidth: 1, borderRadius: T.r8, padding: 10 },
  invBannerText: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 12, flex: 1 },
  ...
  mgrAvatarText: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 12, color: T.primary },
  mgrEmail: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 14, color: T.text },
  mgrSub: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textMuted, marginTop: 1 },
  invRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 12, gap: 10 },
  invPeriod: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 14, color: T.text },
  invMeta: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textSec, marginTop: 2 },
  ...
  actionText: { flex: 1, fontFamily: "PlusJakartaSans_500Medium", fontSize: 15, color: T.text },
  ...
  sheetContent: { gap: 12 },
  editFields: { gap: 10 },
  editLabel: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 11, color: T.textMuted, letterSpacing: 0.8, marginTop: 16, marginBottom: 8 },
  ...
  statusOptionText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 13 },
  ...
  editChipText: { fontFamily: "PlusJakartaSans_500Medium", fontSize: 13 },
  ...
  confirmSub: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 14, color: T.textSec, textAlign: "center", lineHeight: 20 },
  ...
  confirmBtnText: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 15 },
});
