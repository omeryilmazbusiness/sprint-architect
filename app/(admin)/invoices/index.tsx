...
const styles = StyleSheet.create({
  ...
  periodInput: { flex: 1, fontFamily: "PlusJakartaSans_400Regular", fontSize: 15, color: T.text },
  periodHint: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 11, color: T.danger, paddingHorizontal: 16, marginTop: 2 },
  ...
  countLabel: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textMuted, paddingHorizontal: 16, paddingVertical: 8 },
  ...
  clinicName: { fontFamily: "PlusJakartaSans_600SemiBold", fontSize: 15, color: T.text },
  cardMeta: { flexDirection: "row", alignItems: "center", gap: 5 },
  period: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textSec },
  metaDot: { color: T.textMuted, fontSize: 12 },
  patCount: { fontFamily: "PlusJakartaSans_400Regular", fontSize: 12, color: T.textSec },
  cardRight: { flexDirection: "row", alignItems: "center", gap: 8, flexShrink: 0 },
  total: { fontFamily: "PlusJakartaSans_700Bold", fontSize: 14 },
});
